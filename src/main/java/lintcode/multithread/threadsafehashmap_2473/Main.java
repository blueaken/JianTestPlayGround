...
//            }
            ...
            putOperationList.add(new Integer[] {3, 1});
            addMapData(map, 3);
            putOperationList.add(new Integer[] {4, 2});
            addMapData(map, 4);
            putOperationList.add(new Integer[] {6, 5});
            addMapData(map, 6);
            putOperationList.add(new Integer[] {3, 7});
            addMapData(map, 3);

//            getOperationList.add(2);
            getOperationList.add(3);

            final AbstractHashMap hashMap = new ThreadSafeHashMap_2473(baseSize);

...
//            printStream = new PrintStream(outputPath);
            ...
            saveMoneyList.add(50);
            saveMoneyList.add(20);

            List<Integer> withdrawMoneyList = new LinkedList<Integer>();
            withdrawMoneyList.add(60);
            withdrawMoneyList.add(5);
...
//                }
//            }
            final Bank_2497 bank = new Bank_2497(initialBankMoney);
...
//            printStream.write(String.valueOf(bankMoney).getBytes("Utf-8"));
            System.out.println(String.valueOf(bankMoney));
//            printStream.close();
        } catch (Exception e) {
            e.printStackTrace();
        }

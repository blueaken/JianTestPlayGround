...
public class Tictactoe_LE_1275 {
    /*
    ...
    */
    public String tictactoe(int[][] moves) {
        ...
        int n = 3; //for TicTacToe, board size is 3, can fit to other general cases too
        int[] rows = new int[n], cols = new int[n];
        int diag = 0, anti_diag = 0;

        int player = 1;
        //parse the moves info into rows, cols, diag and anti_diag variables
        for (int i = 0; i < len; i++) {
        ...
        //then check each variables and return result
        for (int i = 0; i < n; i++) {
    ...
    public static void main(String[] args) {
        Tictactoe_LE_1275 solution = new Tictactoe_LE_1275();

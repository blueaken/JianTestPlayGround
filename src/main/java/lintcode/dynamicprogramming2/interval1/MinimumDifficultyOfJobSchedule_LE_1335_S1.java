...
public class MinimumDifficultyOfJobSchedule_LE_1335_S1 {
    /*
    ...
    */
        ...
        for (int i = 1; i <= n; i++) {
            for (int k = 1; k <= d; k++) {
                ...
                for (int j = i; j >= k; j--) {
                    ...
                    maxDiffJob = Math.max(maxDiffJob, jd[j]);
    ...
    public static void main(String[] args) {
        MinimumDifficultyOfJobSchedule_LE_1335_S1 solution = new MinimumDifficultyOfJobSchedule_LE_1335_S1();
        int[] jd = {6,5,4,3,2,1};
        int d = 2;

    ...
    */
    public int uniqueLetterString(String s) {
        ...
        for (int i = 0; i < s.length(); i++) {
            ...
            //note the string only consis of uppercase letters
            contribution[cur - 'A'] = i + 1 - lastPositionContribution[cur - 'A'];
            //other letter's contriubtion actually unchanged, but it is easy to understand to iterate each letter and get the updated contribution value
